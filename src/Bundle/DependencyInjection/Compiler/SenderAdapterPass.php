...
final class Sender_Adapter_Pass extends Adapter_Pass
{
    ...
    {
        $this->process_adapters($container, self::ADAPTER_ALIAS, self::DEFAULT_ADAPTER, ['sylius.email_sender.adapter.symfony_mailer' => 'mailer.mailer']);
    }
}